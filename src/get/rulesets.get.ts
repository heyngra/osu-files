...
export class RulesetQuery extends EntityQuery<Ruleset> {
  ...
  /** @example db.rulesets.get.byShortName('osu')[0] */
  byShortName(v: RulesetShortName)     { return this._str('ShortName', '==', v) }
  /** @example db.rulesets.get.byOnlineId(0)[0] */
  byOnlineId(v: number)                { return this._num('OnlineID', '==', v) }
  /** @example db.rulesets.get.byName('osu!') */
