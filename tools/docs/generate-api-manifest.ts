...
import { facadeDefinitions, facadeNames } from './facades.js'
...
for (const facade of facadeDefinitions) catalog.push(`- [\`${facade.name}\`](/api/facades/${facade.name}) - ${facade.description}`)
